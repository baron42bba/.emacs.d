...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/opt/local/bin/git" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/opt/local/bin/git" show-ref "64f1775952dbe001e989f2ab679563b54f2fca55"
  WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/opt/local/bin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/opt/local/bin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/opt/local/bin/git" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
...
if(need_stash)
  execute_process(
    COMMAND "/opt/local/bin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/opt/local/bin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/opt/local/bin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm'."
    ...
    execute_process(
      COMMAND "/opt/local/bin/git" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/andreas/.emacs.d/elpa/vterm-20230417.424/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
