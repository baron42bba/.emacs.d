...
the default value can be customized from the options menu."
  :type '(radio
...
;;;###autoload
(defcustom mouse-avoidance-mode-line-string " Avoid"
  "*String to display in the modeline when `mouse-avoidance-mode' is active.
  ...
  (if (and (not executing-kbd-macro)
	...
	(cond ((and (not mouse-avoidance-state)
	      ...
	      ((and mouse-avoidance-state
	       ...
	       ;; XEmacs change
	       (if (and (eq (car mp) (if (and (< emacs-major-version 20)
