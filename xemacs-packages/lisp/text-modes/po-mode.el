...
;; XEmacs note: this should really be autoloaded, but is currently not due
;; to reportedly intrusive keybindings (not autoloaded upstream either as of
;; gettext 0.13.1).  See also end of file for auto-mode-alist comments.
(defun po-mode ()
...
;; XEmacs addition
;; When `po-mode' sometime is autoloaded, change this to autoload-only.
