...
(defvar tex-mode-hook nil
  "Hook to run in TeX modes (plain-tex-mode, latex-mode, slitex-mode).")

(defvar tex-shell-hook nil
  "Hook to run in TeX modes (plain-tex-mode, latex-mode, slitex-mode),
when the special subshell is initiated.")

(defvar plain-tex-mode-hook nil
  "Hook to run when entering plain-tex-mode.")

(defvar latex-mode-hook nil
  "Hook to run when entering latex-mode.")

(defvar slitex-mode-hook nil
  "Hook to run when entering slitex-mode.")
...
;; XEmacs additions
;;;###autoload(add-to-list 'auto-mode-alist '("\\.ltx\\'" . latex-mode))
;;;###autoload(add-to-list 'auto-mode-alist '("\\.[tT]e[xX]\\'" . tex-mode))
;;;###autoload(add-to-list 'auto-mode-alist '("\\.\\(?:sty\\|cls\\|bbl\\)\\'" . latex-mode))
