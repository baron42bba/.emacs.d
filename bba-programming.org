...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/elpa/key-chord-20250330.2011")
...
#+begin_src emacs-lisp
  (eval-after-load "sql"
    '(progn
      (add-hook 'sql-mode-hook' (lambda() (git-gutter-mode '1)))))
#+end_src
* TemplateToolkit
...
#+BEGIN_SRC emacs-lisp
  ...
  (load-file (expand-file-name "~/.emacs.d/lisp/outline-yaml.el"))
  (add-hook 'yaml-mode-hook 'outline-yaml-minor-mode)
  (add-hook 'yaml-ts-mode-hook 'outline-yaml-minor-mode)
#+END_SRC
