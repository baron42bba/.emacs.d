...
#+BEGIN_SRC emacs-lisp
  (if (>= emacs-major-version 24)
      (progn
        ...
        (defengine vertica
          "https://docs.vertica.com/23.4.x/en/searchResults.html?search=%s"
          :keybinding "v")
...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/elpa/auto-complete-20240320.1734")
  (require 'auto-complete-config)
  (add-to-list 'ac-dictionary-directories "~/.emacs.d/elpa/auto-complete-20240320.1734")
