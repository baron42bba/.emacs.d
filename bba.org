...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
        (add-to-list 'load-path "~/.emacs.d/elpa/async-201910030.2138")
        (require 'async)
        )
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
        ...
        (add-to-list 'load-path "~/.emacs.d/elpa/dash-20191024.1908")
        (require 'smartparens)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'load-path
               "~/.emacs.d/elpa/yasnippet-20191030.1331")
  (require 'yasnippet)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
	(add-to-list 'load-path "~/.emacs.d/elpa/flycheck-20191028.2247")
	(require 'flycheck)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'load-path "~/.emacs.d/elpa/avy-20191024.2310")
  (require 'avy)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (load-file "~/.emacs.d/elpa/org-mime-20190805.57/org-mime.el")
  (add-hook 'org-mode-hook
            (lambda()
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'load-path "~/.emacs.d/elpa/org-sticky-header-20190406.2313" t)
  (add-hook 'org-mode-hook
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
        (add-to-list 'load-path "~/.emacs.d/elpa/elfeed-20190903.1137")
