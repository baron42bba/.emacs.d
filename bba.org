...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  (add-to-list 'load-path "~/.emacs/elpa/org-20170210")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'load-path
	       "~/.emacs.d/elpa/yasnippet-20161110.1226")
  (require 'yasnippet)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (load-file "~/.emacs.d/elpa/org-plus-contrib-20150831/org-mime.el")
  (add-hook 'org-mode-hook
            (lambda()
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (equal "work" (getenv "SYSENV"))
    (progn (split-window-below)
           ...
           (beginning-of-buffer)
           (org-shifttab 3)
           (re-search-forward (concat "^\*\* "(format-time-string "%Y-%m")))
