...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
        (add-to-list 'load-path "~/.emacs.d/elpa/async-20180527.1730")
        (require 'async)
        )
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
        (add-to-list 'load-path "~/.emacs.d/elpa/smartparens-20181028.1005")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
	(add-to-list 'load-path "~/.emacs.d/elpa/flycheck-20180823.826")
	(require 'flycheck)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'load-path "~/.emacs.d/elpa/twittering-mode-20180917.328")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
        (add-to-list 'load-path "~/.emacs.d/elpa/elfeed-20180916.1338")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (if (>= emacs-major-version 24)
      (progn
	(add-to-list 'load-path
                     "~/.emacs.d/elpa/helm-20181029.623")
	(require 'helm)
	(helm-mode 1)
